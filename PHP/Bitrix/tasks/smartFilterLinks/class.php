<?php
    ...
    # --HOST-NAME-- необходимо заменить на текущий host, например foo.ru
    ...
    class CBitrixCatalogSmartFilter extends CBitrixComponent
    {
        ...
        public function getSotbitSmartURNs(array $filterURNs): array
        {
            ...
            $sql = "SELECT `REAL_URL`, `NEW_URL` FROM `--HOST-NAME--`.`b_sotbit_seometa_chpu` WHERE `ACTIVE`= 'Y' AND `REAL_URL` IN({$filterURNsList})";
