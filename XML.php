...
function onStart($parser, $tag, $atributes) { // функция обработчик начальных тегов
...
// file: dom.php
	...
	$decription = $dom->createElement('description');
	$cdata = $dom->createCDATASection('...описание книги...');
	$decription->appendChild($cdata);
	$book->appendChild($decription);
...
<html lang="en">
<head>
	<title>Передача данных методом POST через соект</title>
</head>
<body>
