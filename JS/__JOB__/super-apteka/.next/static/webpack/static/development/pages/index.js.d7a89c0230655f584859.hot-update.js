...
var AppPhoneContainerStyles = Object(styled_components__WEBPACK_IMPORTED_MODULE_2__["default"])(_AppLink__WEBPACK_IMPORTED_MODULE_1__["AppLink"]).withConfig({
  displayName: "AppPhone__AppPhoneContainerStyles",
  componentId: "ny6scz-0"
})(["", ""], function (props) {
  return props.withIcon && "\n    &::before: {\n      content: \"\";\n      background: url(\"/svg/phone.svg\") no-repeat;\n      width: 11.5px;\n      height: 11.5px;\n    }\n  ";
});
var AppPhone = function AppPhone(_ref) {
  var phone = _ref.phone;
  return __jsx(AppPhoneContainerStyles, {
    withIcon: true,
    __self: _this,
    __source: {
...
//# sourceMappingURL=index.js.d7a89c0230655f584859.hot-update.js.map