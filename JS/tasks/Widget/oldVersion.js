((window) => {
  ...
  window['garderoboAssistantWidget']['init'] = async (widgetSettings) => {
    ...
    let settings = {
      ...
      sessionKey: null,
      uriForRequest: {
        authorization: 'https://testapi.garderobo.ai/api/v3/widget/start_session/', // "https://api.garderobo.ai/api/v3/widget/start_session/"
        ...
        return `
            <div class="product">
                ...
                <div class="product__description">
                    <a href='${url}' class="ai-wgt__text">${name}</a>
    ...
    settings = {
      ...settings, key, categoryID, productID, delay,
    };
