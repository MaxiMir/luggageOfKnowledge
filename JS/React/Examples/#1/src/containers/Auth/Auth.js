...
export default class Auth extends Component {
  ...
  onChangeHandler = (event, controlName) => {
    const formControls = { ...this.state.formControls } // копия formControls из state
    const control = { ...formControls[controlName] } // копия контролла из state

    control.value = event.target.value
    control.touched = true // что-то ввели в input
      ...
      <div className={classes.Auth}>
        <div>
          ...
          <form onSubmit={this.submitHandler} className={classes.AuthForm}>
            ...
            ><!-- disabled - если форма не заполнена -->
              Войти
            </Button>
