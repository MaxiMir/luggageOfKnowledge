...
describe('Select component', () => {
  describe('Has props', () => {
    ...
    it('should render select element', () => {
      ...
      expect(select).toHaveLength(1) // toHaveLength - вместо .length
    })
...
// $ npm test:coverage (в папке /coverage/lcov-report/index.html будет информация о покрытии тестами компонентов)