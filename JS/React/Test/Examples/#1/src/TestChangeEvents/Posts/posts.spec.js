...
describe('Posts component', () => {
  ...
  beforeEach(() => {
    component = setUp()
    instance = component.instance() // instance - возвращает наш компонент
  })
  ...
  describe('Post handlers', () => {
    ...
    it('should handle change of hits per page', () => {
      expect(component.state().hitsPerPage).toBe(20) // 20 - по умолчанию
    ...
    it('should handle change page if \'Enter\' clicked', () => {
      instance.setState({page: DEFAULT_PAGE}) // задаем state
