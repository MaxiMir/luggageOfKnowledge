...
* Делает NAT (заменяет внутренний IP на внешний)
...
Все устройства "прячутся" за роутером, и при переходе на сайт, сервер видит только один внешний IP - `92.143.25.11`
...
* Упаковывает в Wi‑Fi-кадр и отправляет

Ноутбук принимает кадр по радио и:
