...
### 1️⃣5️⃣ Layout (Reflow) [Геометрия]
...
### 1️⃣6️⃣ Фаза Paint [отрисовка пикселей]
...
- **Web Workers**, **Worklets** и другие API позволяют выполнять тяжёлые вычисления (рендеринг, ML, аудио) параллельно, не блокируя главный поток.
