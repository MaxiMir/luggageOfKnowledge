     ...
     if ($ifile!=Array())
      {
		...
		echo '<select style="width:100%;font-size:11px;height:100px" size='.$listsize.' oncontextmenu="return ShowMenuExp(event);"  style="font-size:10" align=\'right\' id='.$listid.' onDblClick='.$DblClickAction.'>';
		$select=false;
