...
COPY . /usr/src/app/ # переносим все с текущей директории (нашей машины) в созданную директорию /usr/src/app/
...
$ docker run --rm --name web -p 8080:8080 -e TZ=Europe/Moscow -v /Users/Maxim/PycharmProjects/youtube/docker/web-hello-world/resources:/usr/src/app/resources/ web-hello # -v монтируем папку - абсолютный путь на хостовой машине:абсолютный внутри контейнера ##1 вариант
